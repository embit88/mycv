...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
    ...
    return {
        title: translation.text.meta_title,
        description: translation.text.meta_description,
    };
}
                    ...
                    <div className="col-span-4 sm:col-span-3">
                        <div className="bg-white shadow rounded-lg p-6">
                            <div className="flex flex-col items-center">
                                ...
                                <a href={`mailto:${translation.info.email}`}
                                   className="text-gray-800 m-2">{translation.info.email}</a>
                                <a href={`tel:${translation.info.phone_number}`}
                                   className="text-gray-800 m-2">{translation.info.phone_number}</a>
